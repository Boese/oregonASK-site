(function () {
  ...
  function GridCtrl($scope, $state, $stateParams, $window, Service) {
  ...
  angular.module('schoolApp.grid-controller', ['ui.grid', 'ui.grid.resizeColumns', 'ui.grid.selection', 'ui.grid.exporter', 'ui.grid.importer', 'ui.select', 'angular-underscore'])
